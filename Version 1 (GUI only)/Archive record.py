...
my_canvas.create_window(500, 758, anchor="nw", window=query_Label_HighestEdu)

query_Label_SoftSkills = Label(root, width = 85)
my_canvas.create_window(500, 810, anchor="nw", window=query_Label_SoftSkills)

#Update Button (Need to add command)
img_label = Label(image=UpdateButtonImg)
entryButtonUpdate = Button(root, image=UpdateButtonImg, borderwidth=0, highlightthickness=0, bd=0)
my_canvas.create_window(140, 900, anchor="nw", window=entryButtonUpdate)
...
my_canvas.create_window(471,860, anchor="nw", window=ActiveCheck)

InActiveCheck=Radiobutton(root, image=InactCheckboxImg, variable=var,value=2,borderwidth=0, highlightthickness=0,bd=0)
my_canvas.create_window(630,860, anchor="nw", window=InActiveCheck)
