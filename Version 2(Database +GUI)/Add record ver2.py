...
#It is used to insert new applicant's information into the database.
...
def insertNewRecord ():
    ...
    """Function to insert new applicant's information into the database.
       This function does not have specific input parameters, but the function will get the applicant's information from the entries.
       Output is a message box that shows the message "Record successfully added" if the insertion was successful, or a message box that promts error message if the insertion was not successful."""
